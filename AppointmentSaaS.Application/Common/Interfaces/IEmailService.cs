...
public interface IEmailService
{
    ...
    Task SendEmailVerificationAsync(string toEmail, string name, string verificationToken, CancellationToken ct = default);
    Task SendPasswordResetAsync(string toEmail, string name, string resetToken, CancellationToken ct = default);
}
