...
public class EditModel(IMediator mediator) : PageModel
{
    ...
    {
        BusinessId = id;
        var business = await mediator.Send(new GetBusinessByIdQuery(id), ct);
    ...
    public async Task<IActionResult> OnPostAsync(Guid id, CancellationToken ct)
    {
        ...
        try
        {
            await mediator.Send(new UpdateBusinessCommand(
                id, Input.Name, Input.Type, Input.Address, Input.City, Input.Phone, Input.Email), ct);
