        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RevokedReason = table.Column<string>(type: "TEXT", maxLength: 300, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_StaffId_StartTime_EndTime",
                table: "Appointments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppUsers_IdentityUserId_TenantId",
                table: "AppUsers",
                columns: new[] { "IdentityUserId", "TenantId" },
                unique: true);
